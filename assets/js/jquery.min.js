...
!(function(e, t) {
	...
	w.fn.extend({
		...
		index: function(e) {
			return e
				? 'string' == typeof e ? u.call(w(e), this[0]) : u.call(this, e.jquery ? e[0] : e)
	...
	function $(e, t, n, r) {
		...
		try {
			e && g((i = e.promise))
				...
				: e && g((i = e.then)) ? i.call(e, t, n) : t.apply(void 0, [ e ].slice(r));
		} catch (e) {
			n.apply(void 0, [ e ]);
		}
	}
				...
				i = this[0];
			{
				...
				if (i)
					...
					void 0 !== (n = t.get(i, 'value'))
						? n
						: 'string' == typeof (n = i.value) ? n.replace(bt, '') : null == n ? '' : n;
			}
		}
	}),
		w.extend({
				...
				c ||
					...
					l
						? (h.ifModified &&
							...
							204 === t || 'HEAD' === h.type
								? (C = 'nocontent')
								: 304 === t ? (C = 'notmodified') : ((C = b.state), (p = b.data), (l = !(d = b.error))))
	...
	(h.cors = !!Gt && 'withCredentials' in Gt),
							...
							return function() {
								n &&
									...
									'abort' === e
										? s.abort()
										: 'error' === e
											? 'number' != typeof s.status ? o(0, 'error') : o(s.status, s.statusText)
											: o(
		...
		w.ajaxTransport('script', function(e) {
			if (e.crossDomain) {
				...
				return {
					send: function(i, o) {
						(t = w('<script>').prop({ charset: e.scriptCharset, src: e.url }).on(
							'load error',
							(n = function(e) {
				...
				w.fn[r] = function(i, o) {
					...
					return z(
						...
						function(t, n, i) {
							var o;
							return y(t)
								? 0 === r.indexOf('outer') ? t['inner' + e] : t.document.documentElement['client' + e]
								: 9 === t.nodeType
									? ((o = t.documentElement),
										Math.max(
											t.body['scroll' + e],
